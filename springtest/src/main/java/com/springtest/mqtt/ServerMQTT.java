...
public class ServerMQTT {
    ...
    public static final String HOST = "tcp://mqtt.ref.ecf.cloud:1883";  
    //定义一个主题  
    ...
    public static void main(String[] args) throws MqttException, IOException {  
        ...
        File file = new File("C:/actia/1111/ACTIA000000000011.basic.20171108142000");
        InputStream input  = new FileInputStream(file);
		byte[] b = new byte[(int)file.length()];
		input.read(b);
        server.message.setPayload(b);  
